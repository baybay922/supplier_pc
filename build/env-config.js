...
const ENV_LIST = [
    {
        ...
        envName: 'dev',
        dirName: 'dev',
        baseUrl: 'https://m.duojia369.com',
        assetsPublicPath:'//static.duojia369.com/supplier/'
    },
    {
        //测试环境
        envName: 'test',
        dirName: path.resolve(__dirname, '../wechain'),
        baseUrl: 'https://mfortst.dogotsn.com',
        assetsPublicPath: '//statictst.dogotsn.com/supplier/'
    },
    {
        //生产环境（命令行参数（process.arg）中prod是保留字，所以使用pro）
        envName: 'pro',
        dirName: path.resolve(__dirname, '../wechain'),
        baseUrl: 'https://m.dogotsn.com',
        assetsPublicPath:'//static.dogotsn.com/supplier/'
    },
